...
import { getAll, getById, upload, addVersion, archive, download, getStats, deleteDocument } from '../controllers/ged.controller';
...
gedRouter.delete('/:id', requireGestionnaire, deleteDocument);
